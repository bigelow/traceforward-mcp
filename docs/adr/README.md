...
ADRs follow a lean Nygard-style template: Title, Date, Status, Context, Decision, Consequences.

## Index

| ADR | Title | Status |
|-----|-------|--------|
| [0001](0001-adapter-based-signal-ingestion.md) | Adapter-Based Signal Ingestion | Accepted |
| [0002](0002-mcp-as-the-interface-layer.md) | MCP as the Interface Layer | Accepted |
| [0003](0003-tool-surface-design.md) | Tool Surface Design | Accepted |
